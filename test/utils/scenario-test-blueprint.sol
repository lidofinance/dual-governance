...
// import {SetupDeployment, DeployConfig, DGContractsDeployment} from "./SetupDeployment.sol";
// import {TestingAssertEqExtender} from "./testing-assert-eq-extender.sol";

// uint256 constant MAINNET_FORK_BLOCK_NUMBER = 20218312;
...
//             console.log("Deploy Artifact File %s is used", deployArtifactFileName);
//             _loadDeployArtifact(deployArtifactFileName);
//         }
//         if (_deployConfig.chainId == 1) {
//             vm.createSelectFork(vm.envString("MAINNET_RPC_URL"));
//             vm.rollFork(MAINNET_FORK_BLOCK_NUMBER);
