...
contract DGLaunchStrategiesScenarioTest is DGScenarioTestSetup {
    ...
    function testFork_DualGovernance_DeploymentWithDryRunTemporaryGovernance() external {
        ...
        _step("2. Temporary Emergency Governance Proposer makes dry-run governance reset");
        {
            _emergencyReset();
        }
        ...
        _step(
            string.concat(
                "3. Prepare calls to set Governance, Activation Committee, ",
        ...
        _step("5. Verify the state of the DG setup before voting start");
        {
