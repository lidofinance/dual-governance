...
// import {ScenarioTestBlueprint, DeployConfig, DGContractsDeployment} from "../utils/scenario-test-blueprint.sol";
...
contract PlanBSetup is TimelockedGovernanceTestSetup {
    ...
    function testFork_PlanB_Scenario() external {
        ...
        //             DeployConfig.Context memory dgDeployConfig = _getDefaultDeployConfig({isEmergencyProtectionEnabled: true});
        //             _resealManager = DGContractsDeployment.deployResealManager(_timelock);
        //             _dualGovernanceConfigProvider = DGContractsDeployment.deployDualGovernanceConfigProvider(
        //                 dgDeployConfig.dualGovernance.dualGovernanceConfig
        //             );

        //             _dualGovernance = DGContractsDeployment.deployDualGovernance({
        ...
        //                 }),
        //                 signallingTokens: dgDeployConfig.dualGovernance.signallingTokens,
        //                 sanityCheckParams: dgDeployConfig.dualGovernance.sanityCheckParams
        //             });
        ...
        //                         (address(_deployConfig.timelock.emergencyActivationCommittee))
        //                     ),
        //                     abi.encodeCall(
        //                         _timelock.setEmergencyProtectionExecutionCommittee,
        //                         (address(_deployConfig.timelock.emergencyExecutionCommittee))
        //                     ),
        //                     abi.encodeCall(
        ...
        //             DeployConfig.Context memory dgDeployConfig = _getDefaultDeployConfig({isEmergencyProtectionEnabled: true});
        //             DualGovernance dualGovernanceV2 = DGContractsDeployment.deployDualGovernance({
        //                 components: DualGovernance.DualGovernanceComponents({
        //                     timelock: _timelock,
        //                     resealManager: _resealManager,
        //                     configProvider: _dualGovernanceConfigProvider
        ...
        //             );
        //             assertEq(
        //                 _timelock.getEmergencyExecutionCommittee(), address(_deployConfig.timelock.emergencyExecutionCommittee)
        //             );
