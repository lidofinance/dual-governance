...
// is a placeholder saving version of DualGovernance when
// finding W2-1 was identified. At time of writing this
// finding has not yet been fixed. The finding is also affected
// by Proposers.sol, so a placeholder is kept for that as well.
