...
export const HOODI_PERMISSIONS_CONFIG: PermissionsConfig = {
  genesisBlock: 1,
  ...
  labels: {
    ...
    // DEV Addresses
    "CSM Dev EOA": "0x4AF43Ee34a6fcD1fEcA1e1F832124C763561dA53",
    // DevEOA1: "",
    // DevEOA2: "",
    // DevEOA3: "",
    // DevEOA4: "",
  ...
  aragon: {
    // Core protocol
    Lido: {
      STAKING_CONTROL_ROLE: { manager: "Agent", grantedTo: [] },
    ...
    CuratedModule: {
      ...
      MANAGE_NODE_OPERATOR_ROLE: { manager: "Agent", grantedTo: [] },
      SET_NODE_OPERATOR_LIMIT_ROLE: { manager: "Agent", grantedTo: ["EvmScriptExecutor"] },
      MANAGE_SIGNING_KEYS: { manager: "Agent" },
    },
    SimpleDVT: {
      STAKING_ROUTER_ROLE: { manager: "Agent", grantedTo: ["StakingRouter", "EvmScriptExecutor"] },
      MANAGE_NODE_OPERATOR_ROLE: { manager: "Agent", grantedTo: ["EvmScriptExecutor"] },
      SET_NODE_OPERATOR_LIMIT_ROLE: { manager: "Agent", grantedTo: ["EvmScriptExecutor"] },
      MANAGE_SIGNING_KEYS: { manager: "EvmScriptExecutor", grantedTo: ["Voting", "EvmScriptExecutor"] },
    },
    ACL: {
    ...
    Agent: {
      ...
      RUN_SCRIPT_ROLE: { manager: "Agent", grantedTo: ["DGExecutor"] },
      EXECUTE_ROLE: { manager: "Agent", grantedTo: ["DGExecutor"] },
