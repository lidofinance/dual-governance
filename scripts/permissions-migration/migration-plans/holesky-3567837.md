...
```
13. Create ISSUE_ROLE permission on TokenManager with manager Voting and grant it to Voting
14. Create BURN_ROLE permission on TokenManager with manager Voting and grant it to Voting
15. Create MINT_ROLE permission on TokenManager with manager Voting and grant it to Voting
16. Create REVOKE_VESTINGS_ROLE permission on TokenManager with manager Voting and grant it to Voting
```
...
```
19. Revoke REGISTRY_ADD_EXECUTOR_ROLE permission from Voting on EVMScriptRegistry
20. Set REGISTRY_ADD_EXECUTOR_ROLE manager to Agent on EVMScriptRegistry
21. Revoke REGISTRY_MANAGER_ROLE permission from Voting on EVMScriptRegistry
22. Set REGISTRY_MANAGER_ROLE manager to Agent on EVMScriptRegistry
```
