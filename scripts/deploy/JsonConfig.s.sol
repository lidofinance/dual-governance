...
import {
    ...
    DEFAULT_MAX_ASSETS_LOCK_DURATION,
...
contract DGDeployJSONConfigProvider is Script {
    ...
    function loadAndValidate() external view returns (DeployConfig memory config) {
        ...
        config = DeployConfig({
            ...
            MAX_ASSETS_LOCK_DURATION: Durations.from(
                stdJson.readUintOr(jsonConfig, ".MAX_ASSETS_LOCK_DURATION", DEFAULT_MAX_ASSETS_LOCK_DURATION)
            ),
