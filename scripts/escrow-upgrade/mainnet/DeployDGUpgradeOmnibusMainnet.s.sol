...
import {DGUpgradeOmnibusMainnet} from "./DGUpgradeOmnibusMainnet.sol";
import {DGUpgradeStateVerifierMainnet} from "./DGUpgradeStateVerifierMainnet.sol";
...
contract DeployDGUpgradeOmnibusMainnet is Script {
    function run() public {
        ...
        vm.startBroadcast();
        DGUpgradeStateVerifierMainnet dgUpgradeStateVerifier = new DGUpgradeStateVerifierMainnet(
        ...
        DGUpgradeOmnibusMainnet dgUpgradeOmnibus = new DGUpgradeOmnibusMainnet(
